...
export default async function handlePatchConfirm(req, res) {
...
function measureIdExists(measure_uuid) {
...
function confirmedMeasure(measure_uuid) {
...
function saveMeasure(measure_uuid) {
