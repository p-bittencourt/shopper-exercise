...
function checkExistingMeasure(customer_code, measure_datetime, measure_type) {
    ...
    const existingMeasure = customer.measures.find((m) => {
        ...
        return (existingMonth === measureMonth &&
    ...
    if (existingMeasure) {
        return {
            validClient: true,
            validMeasure: false,
            error_description: `Já existe uma leitura de ${measure_type} para ${measureMonth + 1}/${measureYear}`,
        };
    }
